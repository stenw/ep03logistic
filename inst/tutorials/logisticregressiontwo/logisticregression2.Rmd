...
Now fit the model again after changing the coding of the dummies for LOC such that thoracic is used as reference. Before you run this model, try to find out what will be the estimates for the Constant and for the B’s of the dummies. When you run the new model Check whether the estimates are as expected.
...
What is the predicted probability of neurological deficit for a patient with a thoracic fracture and a stenosis of 60%?
