...
### Question 1
A trial is set up to compare a new procedure against usual care. We investigate the number of interventions.
...
```{r Q3}
quiz(
  question("What is the incidence ratio of the intervention?",
    answer("0.54"),
    answer("0.62"),
    answer("1.62"),
